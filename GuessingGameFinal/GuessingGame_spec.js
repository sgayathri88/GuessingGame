...
describe("Game class", function() {
    ...
    describe("Methods on the Game Constructor Function's `.prototype`", function() {
        ...
        //     //playersGuessSubmission calls checkGuess using player input
        //     it('call checkGuess using player input', function() {
        //         game.winningNumber = 77;
        //         $('#player-input').val(42);
        //         spyOn(Game.prototype, 'checkGuess');
        //         game.playersGuessSubmission();
        //         expect(Game.prototype.checkGuess).toHaveBeenCalled();
        //     })
        //     it('changes #title HTML element to output of checkGuess', function() {
        //         game.winningNumber = 77;
        //         $('#player-input').val(42);
        //         game.playersGuessSubmission();
        //         expect($('#title').val()).toEqual("You're a bit chilly.");
        //     })
        ...
        describe("checkGuess function", function() {
            // checkGuess also does the following:
            // 1. takes a guess as argument from playersGuessSubmission
            // 2. sets playersGuess to guess input
            ...
            it('returns "You Win!" if playersGuess equals winningNumber', function() {
                ...
                expect(game.checkGuess(42)).toEqual('You Win!');
            });
            it('returns "You have already guessed that number." if playersGuess is in pastGuesses', function() {
                game.winningNumber = 42;
                game.checkGuess(36);
                expect(game.checkGuess(36)).toEqual('You have already guessed that number.');
            })
